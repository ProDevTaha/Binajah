        ...
        <section class="hero_section ">
            <div class="hero-container container">
                ...
                <div class="hero_img-container">
                    <div>
                        <img src="images/collegeI.png" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="container mt-5">
        ...
        <div class="layout_padding2 row g-4">
            <div class="col-md-4 col-sm-6">
                <form action="{{route('preparePageCollegeCoures')}}"  method="POST">
                    @csrf
                    <div class="card shadow-sm">
                        <img src="images/phisique.png" class="card-img-top" alt="chimie.png">
                        <input type="hidden" name="image" value="images/phisiqueCourses.png" />
                        <input type="hidden" name="matiere" value="physiquechimie" />
                        <input type="hidden" name="niveau" value="cl" />
                        <div class="card-body">
            ...
            <div class="col-md-4 col-sm-6">
                <form action="{{route('preparePageCollegeCoures')}}"  method="POST">
                    @csrf
                    <div class="card shadow-sm">
                        <img src="images/chimie.png" class="card-img-top" alt="svt.png">
                        <input type="hidden" name="image" value="images/chimieCourses.png" />
                        <input type="hidden" name="matiere" value="svt" />
                        <input type="hidden" name="niveau" value="cl" />
                        <div class="card-body">
                            <button type="submit" role="button" class="btn btn-primary w-100 fw-bold" style="background-color: #fec913;border: none">Sélectionner</button>
                        </div>
            ...
            <div class="col-md-4 col-sm-6">
                <form action="{{route('preparePageCollegeCoures')}}"  method="POST">
                    @csrf
                    <div class="card shadow-sm">
                        <img src="images/francais.png" class="card-img-top" alt="francais.png">
            ...
            <div class="col-md-4 col-sm-6">
                <form action="{{route('preparePageCollegeCoures')}}"  method="POST">
                    @csrf
                    <div class="card shadow-sm">
                        <img src="images/maths.png" class="card-img-top" alt="maths.png">
            ...
            <div class="col-md-4 col-sm-6">
                <form action="{{route('preparePageCollegeCoures')}}"  method="POST">
                    @csrf
                    <div class="card shadow-sm">
                        <img src="images/englash.png" class="card-img-top" alt="englais.png">
            ...
            <div class="col-md-4 col-sm-6">
                <form action="{{route('preparePageCollegeCoures')}}"  method="POST">
                    @csrf
                    <div class="card shadow-sm">
                        <img src="images/arabe.png" class="card-img-top" alt="arabe.png">
            ...
            <div class="col-md-4 col-sm-6">
                <form action="{{route('preparePageCollegeCoures')}}"  method="POST">
                    @csrf
                    <div class="card shadow-sm">
                        <img src="images/islamique.png" class="card-img-top" alt="islamique.png">
            ...
            <div class="col-md-4 col-sm-6">
                <form action="{{route('preparePageCollegeCoures')}}"  method="POST">
                    @csrf
                    <div class="card shadow-sm">
                        <img src="images/social.png" class="card-img-top" alt="social.png">
